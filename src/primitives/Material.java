...
public class Material {
	...
	/**
	 * * Radius/Size of the blur for glossy surfaces and diffuse glass. Represents
	 * the size of the target area. 0.0 means perfect mirror/glass.
	 */
	public double blurRadius = 0.0;
	...
	/**
	 * Setter for the blur radius (target area size).
	 * 
	 * @param blurRadius the size of the blur for glossy/diffuse effects
	 * @return this Material instance
	 */
